...
public static class MauiProgram
{
	public static MauiApp CreateMauiApp()
	{
		...
		// Conditional OCR service registration based on compilation symbol
#if USE_TESSERACT4ANDROID
		builder.Services.AddSingleton<IOcrService, Subzy.Platforms.Android.Services.Tesseract4AndroidOcrService>();
#else
